...
public class AuthFeatureRoutesBuilder
{
    ...
    public AuthFeatureRoutesBuilder(IKuzaineUtilities utilities)
    {
			...
			{{isLoading ? (
				...
				<div className='grid grid-cols-3 gap-4 md:gap-8 max-w-5xl w-full z-20'>
					<div className='flex justify-between items-end col-span-3'>
						...
						<a href='https://github.com/hadrielwonda/Kuzaine' target='_blank' rel='noopener' className='flex justify-end pb-1 sm:pb-2' />
					</div>
					...
					<a href='https://github.com/pdevito3/Kuzaine' target='_blank' rel='noopener' className='cursor-pointer border border-transparent rounded-md transition-colors ease-in col-span-3 sm:col-span-1 p-4 flex flex-col hover:border-gray-600 hover:bg-gray-800'>
						...
						<p className='mt-2'>Powered by an OS project called Kuzaine, all the code available on GitHub. Stars ⭐️ are greatly appreciated!</p>
					</a>
					<a href='https://discord.gg/' target='_blank' rel='noopener' className='cursor-pointer border border-transparent rounded-md transition-colors ease-in col-span-3 sm:col-span-1 p-4 flex flex-col gap-y-4 hover:border-gray-600 hover:bg-gray-800'>
