...
public class DockerComposeBuilders
{
    ...
    public DockerComposeBuilders(IKuzaineUtilities utilities, IFileSystem fileSystem)
    {
...
volumes:
  ...
  {dockerConfig.DbHostName}:{dbService}";
    ...
    {
        var portFor5775 = KuzaineUtilities.GetFreePort();
        var portFor6832 = KuzaineUtilities.GetFreePort();
        var portFor5778 = KuzaineUtilities.GetFreePort();
        var portFor16686Ui = KuzaineUtilities.GetFreePort();
        var portFor14250 = KuzaineUtilities.GetFreePort();
        var portFor14268 = KuzaineUtilities.GetFreePort();
        var portFor14269 = KuzaineUtilities.GetFreePort();
        var portFor9411 = KuzaineUtilities.GetFreePort();
        var services = $@"
...
#      RMQ_PASSWORD: guest
    ...
    {
        var dbPort = KuzaineUtilities.GetFreePort();
        var services = @$"
  keycloakdb:
    image: postgres
    ports:
