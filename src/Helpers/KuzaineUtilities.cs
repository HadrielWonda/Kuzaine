...
public interface IKuzaineUtilities
{
...
public class KuzaineUtilities : IKuzaineUtilities
{
    ...
    public KuzaineUtilities(IConsoleWriter consoleWriter, IFileSystem fileSystem, IAnsiConsole console, IScaffoldingDirectoryStore scaffoldingDirectoryStore)
    {
...
using {parentClassPath.ClassNamespace};";
    ...
    {
        var lowercaseProps = new string[] { "string", "int", "decimal", "double", "float", "object", "bool", "char", "byte", "ushort", "uint", "ulong","guid" };
