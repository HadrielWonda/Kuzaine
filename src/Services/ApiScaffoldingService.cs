...
public class ApiScaffoldingService
{
    ...
    public ApiScaffoldingService(IAnsiConsole console, IConsoleWriter consoleWriter, IKuzaineUtilities utilities, IScaffoldingDirectoryStore scaffoldingDirectoryStore, IFileSystem fileSystem, IMediator mediator, IFileParsingHelper fileParsingHelper)
    {
        _console = console;
